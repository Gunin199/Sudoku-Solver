...
#	ABOUT
Some introductory text about the game and an image will be displayed in a stylistic font. There is a back button at the bottom left corner.
...
Brute force evaluates all 9^81 possible combinations (with each cell having an equal probability of containing numbers 1 through 9. The code runs a validity check for each case, even for redundant cases containing like 9*I9 , until it hits a correct solution.)
