...
def ABOUT(screen) :
	...
	def ins() :
		...
		info4 = font1.render("from 1 to 9 in a given partially completed grid.",True,(255,255,0))

		info5 = font2.render(" ABOUT THE GUI ",True,(0,255,0))

		info6 = font1.render("This game provides you two features i.e Make & Solve and Play .",True,(255,255,0))

		info7 = font1.render("By clicking on 'Make & Solve' button an empty grid is opened , you can fill the grid and create  ",True,(255,255,0) )

		info8 = font1.render("your own sudoku then click solve - immediately solved sudoku will be displayed. ",True,(255,255,0))

		info9 = font1.render("By clicking on the play button you can choose the level of difficulty of the puzzle - Easy/",True,(255,255,0))
